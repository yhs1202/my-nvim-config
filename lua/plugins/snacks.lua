...
return {
  ...
  opts = {
    ...
    -- ️‼️: Additional settings for some modules may be required for full functionality
    ...
    image = { enabled = true }, 	      -- Image viewer using Kitty Graphics Protocol, supported by kitty, wezterm and ghostty	‼️
    ...
    quickfile = { enabled = true }, 	  -- When doing nvim somefile.txt, it will render the file as quickly as possible, before loading your plugins.	‼️
    rename = { enabled = true }, 	      -- LSP-integrated file renaming with support for plugins like neo-tree.nvim and mini.files.	
    scope = { enabled = true }, 	      -- Scope detection, text objects and jumping based on treesitter or indent	‼️
    scratch = { enabled = true },   	  -- Scratch buffers with a persistent file	
    scroll = { enabled = true }, 	      -- Smooth scrolling	‼️
    statuscolumn = { enabled = true },	-- Pretty status column	‼️
